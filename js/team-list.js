...
const roster = [
    { name: "Verbz", role: "Founder", country: "Netherlands", code: "nl", group: "Founders" },
    { name: "Merokin", role: "Founder", country: "Slovakia", code: "sk", group: "Founders" },
    { name: "Pr3ska7", role: "Administrator", country: "Bulgaria", code: "bg", group: "Staff" },
    { name: "Wirzing", role: "Moderator", country: "Germany", code: "de", group: "Staff" },
    { name: "Kapi", role: "Future Player", country: "Poland", code: "pl", group: "Future" }
];
...
function renderRoster() {
    ...
    Object.keys(groups).forEach(groupName => {
        ...
        groups[groupName].forEach(m => {
            const founderClass = groupName === 'Founders' ? ' founder' : '';
            html += `
    ...
    html += `
        <div class="roster-group">
            ...
            <div class="roster-placeholder" style="max-width: 600px; margin: 0 auto;">
                100+ Grinder+ members from all over the world - the foundation of Cosmo eSports. 💪
            </div>
        </div>`;
